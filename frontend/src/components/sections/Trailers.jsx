...
export default function Trailers() {
  return (
    ...
    >
      <PaintSplatter variant="splat1" color="#e63ebd" size={180} style={{ top: "5%", right: "3%" }} rotate={-20} opacity={0.35} />
      <PaintSplatter variant="drip" color="#3db8f2" size={120} style={{ bottom: "10%", left: "3%" }} rotate={15} opacity={0.4} />
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <h2 className="font-display text-white text-3xl sm:text-4xl lg:text-5xl uppercase leading-[0.9]">
              Three trailers. <span className="text-gold underline-marker underline-marker-orange">one standard.</span>
            </h2>
          </div>
